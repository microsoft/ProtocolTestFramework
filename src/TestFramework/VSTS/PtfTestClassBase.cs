            ...
            get
            {
                if (base.Site == null)
                {
                    ...
                    if (configPath != null)
                    {
                        ...
                        string assemblyPath = base.ProtocolTestContext.TestAssemblyDir;
                        ProtocolTestsManager.Initialize(config, assemblyPath, configPath, testSuiteName, testAssemblyName);
                    }
                    else
                    {
                        IConfigurationData config = ConfigurationDataProvider.GetConfigurationData(base.ProtocolTestContext.PtfconfigDir, testSuiteName);
