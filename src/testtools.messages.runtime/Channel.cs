...
namespace Microsoft.Protocols.TestTools.Messages.Runtime
{
    ...
    /// This class allows reading and writing values which are automatically marshaled.
    /// </summary>
    public class Channel : IDisposable
    {
        ...
        /// <summary>
        /// Peeks the value at the given offsets in the stream without changing the current stream position.
        /// </summary>
