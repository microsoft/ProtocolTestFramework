...
namespace Microsoft.Protocols.TestTools.Messages.Runtime
{
    ...
    public static class RuntimeHostProvider
    {
        ...
        /// <summary>
        /// Initialize the message runtime host.
        /// </summary>
        /// <param name="marshallerTrace">If marshaler tracing is enabled</param>
    ...
    internal class DefaultRuntimeHost : IRuntimeHost
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="marshallerTrace">Is marshaler tracing enabled.</param>
        /// <param name="disablevalidation">Is validation disabled.</param>
