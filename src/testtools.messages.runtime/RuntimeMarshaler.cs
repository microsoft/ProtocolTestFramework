...
namespace Microsoft.Protocols.TestTools.Messages.Runtime.Marshaling
{
    /// <summary>
    ...
    public class Marshaler : IDisposable, IEvaluationContext
    {
        ...
        /// <summary>
        /// A container which stores the pointers allocated by the RPC runtime.
        /// </summary>
        ...
        /// <summary>
        /// Checks bit marshaling alignment
        /// </summary>
        ...
        /// <summary>
        /// Defines a pointer symbol and its value in the current context.
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the boolean value which indicates
        ...
        /// <summary>
        /// Inherits from IEvaluationContext, currently not used in Marshaler.
        /// </summary>
        ...
        /// <summary>
        /// Allocates a region which is automatically freed by Dispose or 
        ...
        /// <summary>
        /// Marks a region of memory allocated by RPC runtime for dispose.
        /// </summary>
        /// <param name="ptr">The pointer which points to native memory</param>
        ...
        /// <summary>
        /// Writes zeroes for the given number of bytes.
        /// </summary>
