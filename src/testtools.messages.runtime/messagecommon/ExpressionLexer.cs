...
namespace Microsoft.Protocols.TestTools.Messages.Marshaling
{
    ...
    public class ExpressionLexer
    {
        ...
        /// <summary>
        /// Checks if the input char is an identifier
        /// </summary>
        /// <param name="ch">The input char</param>
        /// <param name="start">Determine whether the char is at the beginning of an expression</param>
        ...
        /// <summary>
        /// Checks if the input char is a number
        /// </summary>
        /// <param name="ch">The input char</param>
        /// <param name="start">Determine whether the char is at the beginning of an expression</param>
        ...
        /// <summary>
        /// Checks if the input char is a white space
        /// </summary>
        /// <param name="ch">The input char</param>
        ...
        /// <summary>
        /// Checks if the input char is an operator
        /// </summary>
        /// <param name="ch">The input char</param>
        ...
        /// <summary>
        /// Checks if the input char is a separator
        /// </summary>
        /// <param name="ch">The input char</param>
        ...
        /// <summary>
        /// Checks if the input operator is supported
        /// </summary>
        ...
        /// <summary>
        /// Makes token for the input operator 
        /// </summary>
        /// <param name="op">The input operator (in string format)</param>
        ...
        /// <summary>
        /// Makes token for the input number
        /// </summary>
        ...
        /// <summary>
        /// Makes token for the input identifier
        /// </summary>
        ...
        /// <summary>
        /// Makes token for the input separator
        /// </summary>
        ...
        /// <summary>
        /// Makes invalid token for the input string
        /// </summary>
