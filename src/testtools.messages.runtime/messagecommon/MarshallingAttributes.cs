...
namespace Microsoft.Protocols.TestTools.Messages.Marshaling
{
    ...
    {
        /// <summary>
        /// Indicates to evaluate the static size of bytes.
        /// </summary>
        Bytes,

        /// <summary>
        /// Indicates to evaluate the static size of elements.
        /// </summary>
        Elements
    }
    ...
    public sealed class CustomMarshalerAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="type">The type which is the custom marshaler type.</param>
    ...
    /// <summary>
    /// An attribute which specifies a method to determine whether a field should be marshaled/unmarshaled.
    /// </summary>
    // The following suppression is adopted because these fields are only used by reflection, there is no need to define accessors.
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1019:DefineAccessorsForAttributeArguments")]
    [AttributeUsage(AttributeTargets.Field, AllowMultiple = false)]
    ...
    /// If this attribute is not attached to the asn.1 type, the aligned mode will be used.
    /// </summary>
