...
namespace Microsoft.Protocols.TestTools
{
    ...
    public class DataType
    {
        ...
        public class TestCaseDetail
        {
            ...
            public TestCaseDetail(string name, string fullyQualifiedName, DateTimeOffset startTime, DateTimeOffset endTime, string result, string source, string classType, List<string> categories)
            {
                this.Name = name;
        ...
        /// </summary>
        public class TestCaseDetailForJson: TestCaseDetail
        {
            /// <summary>
            /// The start time of the test case
            /// </summary>
            ...
            {
                Name = detail.Name;
                FullyQualifiedName = detail.FullyQualifiedName;
