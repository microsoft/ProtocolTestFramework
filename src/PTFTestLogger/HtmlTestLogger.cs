...
namespace Microsoft.Protocols.TestTools
{
    ...
    public class HtmlTestLogger : ITestLoggerWithParameters
    {
        ...
        private const string cssFileName = "casepage.css";
        ...
        private void CreateReportFolder()
        {
            ...
            File.WriteAllText(Path.Combine(jsFolderPath, cssFileName), Properties.Resources.casepage);
        }
        ...
        private string ConstructListAndSummaryObj(TestRunCompleteEventArgs e)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine();
            sb.AppendLine("var listObj = " + txtToJSON.TestCasesString(results) + ";");
